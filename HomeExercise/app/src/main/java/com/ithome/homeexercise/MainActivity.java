...
import com.ithome.homeexercise.adapter.InventoryAdapter;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void loadData() {
        ...
        String dbUrl = "https://api.myjson.com/bins/1f51a0";  //"https://api.myjson.com/bins/x6gys"; // "https://api.myjson.com/bins/1f19ec"; // json file url
